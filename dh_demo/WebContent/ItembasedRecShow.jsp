...
if(!ValidateUtil.isValid(imgurlString)||!ValidateUtil.isValid(itemcodeString)||!ValidateUtil.isValid(supplieridString)||!ValidateUtil.isValid(maxcostString)||!ValidateUtil.isValid(mincostString)||!ValidateUtil.isValid(itemnameString)){
